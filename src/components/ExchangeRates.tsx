  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="flex flex-wrap gap-2 bg-white/10 backdrop-blur-lg rounded-xl p-4 border border-white/20">
          <span className="text-white/80 text-sm font-medium mr-2">Time Period:</span>
          {periods.map((period) => (
            <button
              key={period}

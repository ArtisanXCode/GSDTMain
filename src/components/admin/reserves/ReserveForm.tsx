    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-2.5">
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, value_usd: e.target.value })
              }
              className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6"
              placeholder="e.g., 1000000"
              step="any"
            />
            {errors.value_usd && (
              <p className="mt-1 text-sm text-red-600">{errors.value_usd}</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-2.5">
            ...
            />
            {errors.custodian && (
              <p className="mt-1 text-sm text-red-600">{errors.custodian}</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-2.5">
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, audit_url: e.target.value })
              }
              className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6"
      ...
      <div className="mt-6 flex justify-end space-x-4">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-semibold rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 bg-green-600"
        >
          {isLoading ? (
            <>
              <svg

    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <div className="mt-2 bg-gray-50 p-4 rounded-lg text-black">
              <p className="text-sm">
                <span className="font-medium">Name:</span> {request.first_name}{" "}
                {request.last_name}
              </p>
          ...
          <div>
            ...
            <div className="mt-2 bg-gray-50 p-4 rounded-lg text-black">
              <p className="text-sm">
                ...
                <span
                  className={`ml-2 px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadgeClass(request.status)}`}
                >
                  {request.status}
                </span>
              </p>
        ...
        <div className="flex justify-end space-x-4 mt-6">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-100 bg-gray-500 hover:bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            Close
          </button>

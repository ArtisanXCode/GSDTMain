...
export const MULTISIG_ADMIN_ADDRESS = "" as const; // Update after deployment
...
export const MULTISIG_ADMIN_ABI = [
  // Add MultiSig Administrative contract ABI after deployment
] as const;

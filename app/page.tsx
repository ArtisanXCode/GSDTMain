...
const features = [
  {
    ...
    description:
      "Every transaction is protected by advanced cryptography and smart contract security.",
    icon: LockClosedIcon,
  },
  {
    name: "Real-time Exchange Rates",
    description:
      "Get up-to-date exchange rates for BRICS currencies against USDC.",
    icon: ArrowPathIcon,
  },
  {
    name: "Backed by Real Assets",
    description:
      "GSDC is backed by a diversified basket of BRICS government bonds and securities.",
    icon: CloudArrowUpIcon,
  },
];

const stats = [
  { id: 1, name: "Total Supply", value: "10M GSDC", icon: ChartBarIcon },
  {
    id: 2,
    name: "Current Price",
    value: "$1.00 USDC",
            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8 text-primary-100">
                  A revolutionary stablecoin backed by BRICS currencies and
                  real-world assets, bringing stability and accessibility to
                  digital finance.
                </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              GSDC is backed by a carefully weighted basket of BRICS currencies,
      ...
      <div className="bg-primary-900 text-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-primary-100">
              GSDC combines the stability of BRICS currencies with the
          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg leading-8 text-gray-600">
                GSDC is rapidly becoming the preferred stablecoin for
